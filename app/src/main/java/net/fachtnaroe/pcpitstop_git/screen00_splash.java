...
public class screen00_splash extends Form implements HandlesEventDispatching
{
    ...
    {
            Intent LoginScreenIntent = new Intent(screen00_splash.this, screen01_startingLogin.class);
