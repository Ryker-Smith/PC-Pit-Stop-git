...
public class splash_screen00 extends Form implements HandlesEventDispatching
{
    ...
    {
            Intent LoginScreenIntent = new Intent(splash_screen00.this, startingLogin_screen01.class);
